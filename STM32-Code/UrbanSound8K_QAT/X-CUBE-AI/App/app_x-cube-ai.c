...
AI_ALIGNED(32)
static uint8_t pool0[AI_PQAT_MODEL_DATA_ACTIVATION_1_SIZE];
...
static const ai_network_entry_t networks[AI_MNETWORK_NUMBER] = {
    {
        .name = (const char *)AI_PQAT_MODEL_MODEL_NAME,
        .config = AI_PQAT_MODEL_DATA_CONFIG,
        .ai_get_report = ai_pqat_model_get_report,
        .ai_create = ai_pqat_model_create,
        .ai_destroy = ai_pqat_model_destroy,
        .ai_get_error = ai_pqat_model_get_error,
        .ai_init = ai_pqat_model_init,
        .ai_run = ai_pqat_model_run,
        .ai_forward = ai_pqat_model_forward,
        .ai_data_params_get = ai_pqat_model_data_params_get,
