...
#define AI_NETWORK_1_DATA_ACTIVATIONS_SIZES \
  { 36592, }
#define AI_NETWORK_1_DATA_ACTIVATIONS_SIZE     (36592)
#define AI_NETWORK_1_DATA_ACTIVATIONS_COUNT    (1)
#define AI_NETWORK_1_DATA_ACTIVATION_1_SIZE    (36592)



#define AI_NETWORK_1_DATA_WEIGHTS_SIZES \
  { 7528, }
#define AI_NETWORK_1_DATA_WEIGHTS_SIZE         (7528)
#define AI_NETWORK_1_DATA_WEIGHTS_COUNT        (1)
#define AI_NETWORK_1_DATA_WEIGHT_1_SIZE        (7528)
