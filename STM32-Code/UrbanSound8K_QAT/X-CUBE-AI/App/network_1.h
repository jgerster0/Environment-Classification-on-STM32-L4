...
#define AI_NETWORK_1_ORIGIN_MODEL_NAME   "test"
...
#define AI_NETWORK_1_IN_1_HEIGHT      (13)
#define AI_NETWORK_1_IN_1_WIDTH       (124)
#define AI_NETWORK_1_IN_1_CHANNEL     (1)
#define AI_NETWORK_1_IN_1_SIZE        (1612)
#define AI_NETWORK_1_IN_1_SIZE_BYTES  (6448)
...
#define AI_NETWORK_1_OUT_1_CHANNEL     (10)
#define AI_NETWORK_1_OUT_1_SIZE        (10)
#define AI_NETWORK_1_OUT_1_SIZE_BYTES  (40)
